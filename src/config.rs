...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Admin@h3c.com".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rd.112766.xyz"];
pub const RS_PUB_KEY: &str = "AtbjQ+tB2pgcPD4FirhkMNMg2inO4SVolgt+eAqlM8A=";
